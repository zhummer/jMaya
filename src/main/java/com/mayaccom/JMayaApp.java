...
import com.mayaccom.config.ApplicationProperties;
import com.mayaccom.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class JMayaApp {

    private static final Logger log = LoggerFactory.getLogger(JMayaApp.class);

    private final Environment env;

    public JMayaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JMayaApp.class);
